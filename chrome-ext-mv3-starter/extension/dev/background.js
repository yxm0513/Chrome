...
(() => {
  ...
  var commonProperties, toJsonWasCalled, toJSON, destroyCircular;
  ...
  var import_webextension_polyfill, import_tiny_uid, import_webextension_polyfill2, import_tiny_uid2, import_tiny_uid3, ENDPOINT_RE, parseEndpoint, hasAPI, getBackgroundPageType, context, runtimeId, openTransactions, onMessageListeners, messageQueue, portMap, port, namespace, isWindowMessagingAllowed, _Stream, Stream, onOpenStreamCallbacks, streamyEmitter;
  var init_dist = __esm({
    "node_modules/.pnpm/webext-bridge@5.0.5/node_modules/webext-bridge/dist/index.mjs"() {
      init_nanoevents();
      import_webextension_polyfill = __toESM(require_browser_polyfill(), 1);
      init_serialize_error();
      import_tiny_uid = __toESM(require_tiny_uid(), 1);
      import_webextension_polyfill2 = __toESM(require_browser_polyfill(), 1);
      import_tiny_uid2 = __toESM(require_tiny_uid(), 1);
      import_tiny_uid3 = __toESM(require_tiny_uid(), 1);
      init_nanoevents();
      ENDPOINT_RE = /^((?:background$)|devtools|popup|options|content-script|window)(?:@(\d+)(?:\.(\d+))?)?$/;
      ...
      hasAPI = (nsps) => import_webextension_polyfill2.default[nsps];
      ...
      context = hasAPI("devtools") ? "devtools" : hasAPI("tabs") ? getBackgroundPageType() : hasAPI("extension") ? "content-script" : typeof document !== "undefined" ? "window" : null;
      runtimeId = (0, import_tiny_uid.default)();
      openTransactions = /* @__PURE__ */ new Map();
      onMessageListeners = /* @__PURE__ */ new Map();
      messageQueue = /* @__PURE__ */ new Set();
      ...
      onOpenStreamCallbacks = /* @__PURE__ */ new Map();
  ...
  var require_background = __commonJS({
    "src/background/index.ts"(exports) {
      init_dist();
      chrome.runtime.onInstalled.addListener(() => {
        console.log("Extension installed");
      });
      var previousTabId = 0;
      chrome.tabs.onActivated.addListener((_0) => __async(exports, [_0], function* ({ tabId }) {
        if (!previousTabId) {
          previousTabId = tabId;
          return;
        }
        const tab = yield chrome.tabs.get(previousTabId);
        previousTabId = tabId;
        if (!tab)
          return;
      ...
      onMessage("get-current-tab", () => __async(exports, null, function* () {
        try {
          const tab = yield chrome.tabs.get(previousTabId);
          return {
            title: tab == null ? void 0 : tab.id
          };
        } catch (e) {
          return {
            title: void 0
